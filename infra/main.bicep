metadata description = 'Provisions resources for a web application that uses Azure SDK for Go to connect to Azure Cosmos DB for Table.'
...
var tags = {
  ...
  repo: 'https://github.com/azure-samples/cosmos-db-table-go-quickstart'
}
